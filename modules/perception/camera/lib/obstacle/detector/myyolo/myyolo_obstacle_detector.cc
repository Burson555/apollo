 ...
 *****************************************************************************/
#include "modules/perception/camera/lib/obstacle/detector/myyolo/myyolo_obstacle_detector.h"
...
void MyYoloObstacleDetector::LoadInputShape(
...
void MyYoloObstacleDetector::LoadParam(const yolo::YoloParam &yolo_param) {
...
bool MyYoloObstacleDetector::InitNet(const yolo::YoloParam &yolo_param,
...
void MyYoloObstacleDetector::InitYoloBlob(const yolo::NetworkParam &net_param) {
...
bool MyYoloObstacleDetector::Init(const ObstacleDetectorInitOptions &options) {
...
bool MyYoloObstacleDetector::InitFeatureExtractor(const std::string &root_dir) {
...
bool MyYoloObstacleDetector::Detect(const ObstacleDetectorOptions &options,
                                  CameraFrame *frame) {
  if (frame == nullptr) {
    return false;
  }
...
REGISTER_OBSTACLE_DETECTOR(MyYoloObstacleDetector);
